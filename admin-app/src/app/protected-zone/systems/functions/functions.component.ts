...
import { FunctionService, NotificationService, UtilitiesService } from '../../../shared/services';
...
export class FunctionsComponent implements OnInit {
  ...
  loadData(selectionId = null) {
    ...
    this.functionsService.getAll().subscribe(
      (response: any) => {
  ...
  loadDataCommand() {
    ...
    this.functionsService.getAllCommandsByFunctionId(this.selectedItems[0].id).subscribe(
      (response: any) => {
